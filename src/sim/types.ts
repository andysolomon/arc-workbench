...
export interface Metrics { nodes: Record<string, NodeStat>; edges: Record<string, number>; sys: SysStat; run?: RunState | null; tl?: Timeline }
...
export interface ParadigmSim {
  pid: string; t: number; acc: number; runs: Run[]; done: number[]; edgeN: Record<string, number>; nodeN: Record<string, number>;
